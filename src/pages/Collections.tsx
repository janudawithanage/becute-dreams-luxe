...
export function Collections() {
  ...
  const pagination = usePagination(collections, { pageSize: 8 });
    ...
    <div className="page-enter mx-auto max-w-[1400px] px-6 py-16 lg:px-12 lg:py-24">
      ...
      <div className="mt-16 space-y-4">
        {collections.length === 0 ? (
          ...
          <>
            {pagination.paginatedItems.map((collection, i) => (
              <motion.div
                key={collection.id}
                initial={{ opacity: 0, y: 24 }}
            ...
            {pagination.totalPages > 1 && (
              ...
              >
                ...
                <p className="text-xs text-muted-foreground">
                  Page {pagination.currentPage} of {pagination.totalPages} &middot; {collections.length} collections
                </p>
              </motion.div>
            )}
          </>
