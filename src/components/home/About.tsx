  ...
  return (
    <section className="mx-auto max-w-[1400px] px-6 py-24 lg:px-12 lg:py-32">
      <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-20">
        ...
        >
          <img src={about} alt="Inside the Becute Dreams atelier" loading="lazy" className="aspect-[5/6] w-full object-cover" />
        </motion.div>
        ...
        <div className="lg:col-span-5">
          ...
          <div className="mt-10 grid grid-cols-2 gap-6 border-t pt-8">
            <div>
              ...
              <p className="mt-1 text-xs uppercase tracking-[0.2em] text-muted-foreground">Years of soft work</p>
            </div>
            <div>
              <p className="font-display text-4xl">100%</p>
              <p className="mt-1 text-xs uppercase tracking-[0.2em] text-muted-foreground">Small-batch made</p>
            </div>
          </div>
        </div>
      </div>
