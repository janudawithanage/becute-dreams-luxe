...
function Collections() {
  return (
    <div className="mx-auto max-w-[1400px] px-6 py-16 lg:px-12 lg:py-24">
      ...
      <h1 className="mt-3 max-w-3xl font-display text-6xl tracking-tight lg:text-8xl">Curated <em className="font-light">worlds.</em></h1>
            ...
            >
              <div className="md:col-span-5">
                <div className="aspect-[16/10] overflow-hidden md:aspect-square">
                  <img src={c.image} alt={c.name} loading="lazy" className="h-full w-full object-cover transition duration-[1200ms] group-hover:scale-110" />
                </div>
              </div>
              <div className="flex items-center justify-between px-6 pb-6 pr-8 md:col-span-7 md:py-12">
                <div>
                  <p className="text-xs uppercase tracking-[0.3em] text-muted-foreground">0{i + 1} · Collection</p>
